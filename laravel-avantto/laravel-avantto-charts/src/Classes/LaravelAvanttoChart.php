...
namespace LaravelAvanttoCharts\Classes;
...
class LaravelAvanttoChart
{
    ...
    /**
     * LaravelAvanttoChart constructor.
     * @param $chart_options
     * @throws \Exception
     */
    ...
    {
        return view('laravelAvanttoChart::html', ['options' => $this->options]);
    }
    ...
    {
        return view('laravelAvanttoChart::javascript', ['options' => $this->options, 'datasets' => $this->datasets]);
    }
